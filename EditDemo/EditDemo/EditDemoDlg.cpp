...
void CEditDemoDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_PAWD, m_strPawd);
	DDV_MaxChars(pDX, m_strPawd, 5);
}
...
BEGIN_MESSAGE_MAP(CEditDemoDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_EN_CHANGE(IDC_NAME, &CEditDemoDlg::OnEnChangeName)
	ON_BN_CLICKED(IDC_BUTTON2, &CEditDemoDlg::OnBnClickedButton2)
END_MESSAGE_MAP()
...
void CEditDemoDlg::OnEnChangeName()
{
