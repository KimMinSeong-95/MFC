...
BEGIN_MESSAGE_MAP(CMenuDemoApp, CWinApp)
	...
	ON_COMMAND(ID_MUSICSTART, &CMenuDemoApp::OnMusicstart)
	ON_COMMAND(ID_MUSICSTOP, &CMenuDemoApp::OnMusicstop)
	ON_UPDATE_COMMAND_UI(ID_MUSICSTART, &CMenuDemoApp::OnUpdateMusicstart)
	ON_UPDATE_COMMAND_UI(ID_MUSICSTOP, &CMenuDemoApp::OnUpdateMusicstop)
	ON_COMMAND(ID_MUSICPAUSE, &CMenuDemoApp::OnMusicpause)
	ON_UPDATE_COMMAND_UI(ID_MUSICPAUSE, &CMenuDemoApp::OnUpdateMusicpause)
END_MESSAGE_MAP()
...
void CMenuDemoApp::OnMusicpause()
{
	...
	{
		// 다시 재생 하겠다.
		AfxMessageBox(_T("다시 재생"));
		m_bPause = FALSE;
	}
	else
	{
		// 일시 정지하겠다.
		AfxMessageBox(_T("일시 정지"));
		m_bPause = TRUE;
	}
}
